...
const NewshortUrlJoiSchema = Joi.object({
  url: Joi.object({
    ...
    customDomain: Joi.string()
      .hostname() // Valid domain name (e.g., hello.com)
      .optional()
      .allow('', null)
      .messages({
    ...
    generateQR: Joi.string()
      .optional()
      .allow('', null)
      .valid('true', 'false') // String "true" or "false" from client
      .messages({
...
module.export = NewshortUrlJoiSchema;