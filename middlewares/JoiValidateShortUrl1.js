...
// Joi Schema 1
const shortUrlJoiSchema1 = Joi.object({
  url: Joi.object({
...
// Middleware
const JoiValidateShortUrl1 = (req, res, next) => {
  const { error, value } = shortUrlJoiSchema1.validate(req.body, {
    abortEarly: false,
    stripUnknown: true,
  });
...
module.exports = JoiValidateShortUrl1;